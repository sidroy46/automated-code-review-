...
export default function RightPanel({ 
  ...
  if (error) {
    return (
      <div className="glass-panel-futuristic p-8 rounded-2xl flex flex-col items-center justify-center text-center flex-grow shadow-2xl min-h-[500px] border-red-500/10 bg-red-950/5">
